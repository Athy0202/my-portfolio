    ...
    <div className="row gy-4">
      ...
      <div className="col-md-6">
        <div className="card bg-dark text-light border-0 shadow-sm">
          <img src="/images/design1.jpg" className="card-img-top rounded" alt="Chat Sticker Set" />
      ...
      <div className="col-md-6">
        <div className="card bg-dark text-light border-0 shadow-sm">
          <img src="/images/design2.jpg" className="card-img-top rounded" alt="Name Card Design" />
          <div className="card-body">
      ...
      <div className="col-md-6">
        <div className="card bg-dark text-light border-0 shadow-sm">
          <img src="/images/design3.jpg" className="card-img-top rounded" alt="Logo Design Concept" />
          <div className="card-body">
      ...
      <div className="col-md-6">
        <div className="card bg-dark text-light border-0 shadow-sm">
          <img src="/images/design4.jpg" className="card-img-top rounded" alt="Logo on Applications" />
          <div className="card-body">
